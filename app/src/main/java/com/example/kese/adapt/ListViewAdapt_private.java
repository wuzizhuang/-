...
public class ListViewAdapt_private extends ArrayAdapter<ListModel> {

    private  Context mContext;
    private int mResource;

    public ListViewAdapt_private(@NonNull Context context, int resource, @NonNull ArrayList<ListModel> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView name =convertView.findViewById(R.id.list_item_my_name);
